...
server = StreamBotAPI([streambot1,streambot2, streambot3, streambot4], origins=["http://localhost:3000","https://paisley-ui-develop-arxkt.ondigitalocean.app","https://paisley-proto.thegenie.ai"], verbosity=1, debug=False, allow_model_override=True)
